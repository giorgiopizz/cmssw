// -*- C++ -*-
//
// Package:    TrackingTools/TTProd
// Class:      TTProd
//
/**\class TTProd TTProd.cc TrackingTools/TTProd/plugins/TTProd.cc
...
class TTProd : public edm::stream::EDProducer<> {
public:
  explicit TTProd(const edm::ParameterSet&);
  ~TTProd();
...
//
TTProd::TTProd(const edm::ParameterSet& iConfig)
{
...
void TTProd::beginStream(edm::StreamID) {
  // please remove this method if not needed
}

// ------------ method called once each stream after processing all runs, lumis and events  ------------
void TTProd::endStream() {
  // please remove this method if not needed
}
...
/*
void
TTProd::beginRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void
TTProd::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void
TTProd::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void
TTProd::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void TTProd::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
