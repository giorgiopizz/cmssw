#ifndef gpu_DAClusterizerInZ_h
#define gpu_DAClusterizerInZ_h

/**\class gpu_DAClusterizerInZ 
...
class gpu_DAClusterizerInZ : public TrackClusterizerInZ {
public:
  struct track_t {
  ...
  gpu_DAClusterizerInZ(const edm::ParameterSet &conf);
